"""Stage 2: identical sixteen physical variables, refined spectral coordinates.
...
ROOT = HERE.parents[1] / 'archive/multivariate-l12-v1'
COARSE = HERE.parents[1] / 'archive/multivariate-seasonal-v1'
DEGREE = 12
GRID_STEP = 1.25
